...
import (
	...
	"github.com/bhagyaraj1208117/andes-abc-1/data/dct/proto"
	vmcommon "github.com/bhagyaraj1208117/andes-common-go-2"
...
func TestDCTNFTMultiTransfer_ProcessBuiltinFunctionOnSameShardShouldCheckTokenValueLength(t *testing.T) {
	t.Parallel()
